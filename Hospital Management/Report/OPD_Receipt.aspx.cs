...
{
    public partial class OPD_Receipt : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            if (RollNo != null)
            {
                ...
                cmd.Connection = con;
                cmd.Connection.Open();
                cmd.CommandText = "OPD_Receipt";
                SqlDataAdapter da = new SqlDataAdapter(cmd);
                cmd.Parameters.AddWithValue("@MainId", RollNo);
                da.TableMappings.Add("Table", "OPD_Receipt");
                da.TableMappings.Add("Table1", "OPD_Receipt1");

                da.Fill(ds);

                Session["reportpath"] = "~/CR_Reports/OPD_Receipt.rpt";
                String RptFilePath;
