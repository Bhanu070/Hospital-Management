...
using System.Text;
namespace Hospital_Management.AppCode
{
    public class Constant
    {
        ...
        public static List<ListItem> UserTitle
        {
            get
            {
                List<ListItem> items = new List<ListItem>
                     {
                             ...
                             new ListItem{ Text="Miss", Value = "Miss" },
                     };
                return items;
            }
        }
        ...
        // start Hr Code 
        public static List<ListItem> Finyear
        {
            ...
            get
            {
                ...
                new ListItem{ Value="Select Current  Year", Text = "2021" },
        ...
        public static List<ListItem> EmployeeStatus
        {
            ...
            get
            {
                ...
                new ListItem{ Text="Revert", Value = "1" },
                             new ListItem{ Text="Approved", Value = "2" },
        ...
        public static List<ListItem> PassingYear
        {
            get
            {
                ...
                {
                    yearlist.Add(new ListItem() { Value = i.ToString(), Text = i.ToString() });
                ...
                List<ListItem> items = new List<ListItem>
                     {
                             ...
                             new ListItem{ Text="Employee", Value = "Employee" },
                             new ListItem{ Text="User", Value = "User" },
                             new ListItem{ Text="CEO", Value = "CEO" },
                             new ListItem{ Text="Clerk", Value = "Clerk" },
                             new ListItem{ Text="Record Keeper", Value = "Record Keeper" },
                             new ListItem{ Text="Waqf Inspector", Value = "Waqf Inspector" },
                             new ListItem{ Text="HR", Value = "HR" },
                             new ListItem{ Text="Aaccountant", Value = "Aaccountant" },
                             new ListItem{ Text="Chairman", Value = "Chairman" },
                     };
                return items;
            }
        }
        public static List<ListItem> NotificationType
        {
            get
            {
                List<ListItem> items = new List<ListItem>
                     {
                             new ListItem{ Text="Exam", Value = "Exam" },
                             new ListItem{ Text="Live Classes", Value = "Live Classes" },
                             new ListItem{ Text="Study", Value = "Study" },
                             new ListItem{ Text="Subject", Value = "Subject" },
                             new ListItem{ Text="Calender", Value = "Calender" },

                     };
                return items;
            }
        }
        public static List<ListItem> ExamType
        {
            get
            {
                List<ListItem> items = new List<ListItem>
                     {
                             new ListItem{ Text="Free for All", Value = "Free for All" },
                             new ListItem{ Text="Paid for All", Value = "Paid for All" },
                             new ListItem{ Text="Free for Registred User", Value = "Free for Registred User" },
                             new ListItem{ Text="Free for Demo User", Value = "Free for Demo User" },
                     };
                return items;
            }
        }
        public static List<ListItem> UserStatus
        {
            get
            {
                List<ListItem> items = new List<ListItem>
                     {
                             ...
                             new ListItem{ Text="Approve", Value = "Approve" },
                             new ListItem{ Text="Block", Value = "Block" },
        ...
        public static List<ListItem> AppointmentProcedure
        {
            get
            {
                List<ListItem> items = new List<ListItem>
                     {
                             new ListItem{ Text="By Waqf Deed", Value = "By Waqf Deed" },
                             new ListItem{ Text="Riwaz (Custom)", Value = "Riwaz (Custom)" },
                              new ListItem{ Text="By Election", Value = "By Election" },
                     };
                return items;
            }
        }
        ...
        public static List<ListItem> CommitteeMember
        {
            get
            {
                List<ListItem> items = new List<ListItem>
                     {
                             new ListItem{ Text="President", Value = "president" },
                             new ListItem{ Text="Vice-President", Value = "Vice-President" },
                             new ListItem{ Text="Secretary ", Value = "Secretary" },
                             new ListItem{ Text="Treasurer", Value = "Treasurer" },
                             new ListItem{ Text="Member", Value = "Member" },
        ...
        public static List<ListItem> IdProof
        {
            get
            {
                List<ListItem> items = new List<ListItem>
                     {
                             new ListItem{ Text="Voter ID", Value = "Voter ID" },
                             new ListItem{ Text="Passport", Value = "Passport" },
                             new ListItem{ Text="Driving License", Value = "Driving License" },
                             new ListItem{ Text="Pan Card", Value = "Pan Card" },
                               new ListItem{ Text="Arm's License", Value = "Arm's License" },
                             new ListItem{ Text="Aadhaar Card", Value = "Aadhaar Card" },
                               new ListItem{ Text="I.D Card Issue by Centeral Govt /State Govt/Public Sector Undertaking", Value = "I.D Card Issue by Centeral Govt /State Govt/Public Sector Undertaking" },
                     };
                return items;
            }
        }
        public static List<ListItem> ResdProof
        {
            get
            {
                List<ListItem> items = new List<ListItem>
                     {
                             new ListItem{ Text="House Tax Bill/Receipt", Value = "House Tax Bill/Receipt" },
                             new ListItem{ Text="Electricity Bill", Value = "Electricity Bill" },
                             new ListItem{ Text="Water Tax Bill/Receipt", Value = "Water Tax Bill/Receipt" },
                              new ListItem{ Text="Any Document Mentioned Form", Value = "Any Document Mentioned Form" },
                              };
                return items;
            }
        }
        ...
        public static List<ListItem> no_of_copy
        {
            get
            {
                List<ListItem> items = new List<ListItem>
        ...
        public static List<ListItem> WaqfType
        {
            get
            {
                List<ListItem> items = new List<ListItem>
                     {
                             new ListItem{ Text="Waqf by User", Value = "Waqf by User" },
                             new ListItem{ Text="Waqf Alal Khair", Value = "Waqf Alal Khair" },
                             new ListItem{ Text="Waqf Alal Aulad", Value = "Waqf Alal Aulad" },
        ...
        public static List<ListItem> paymentmode
        {
            get
            {
                List<ListItem> items = new List<ListItem>
                     {
                             new ListItem{ Text="Cash", Value = "Cash" },
                             new ListItem{ Text="Cheque", Value = "Cheque" },
        ...
        public static List<ListItem> Acctype
        {
            get
            {
                List<ListItem> items = new List<ListItem>
                     {
                             new ListItem{ Text="Current Account", Value = "Current Account" },
                             new ListItem{ Text="Saving Account", Value= "Saving Account" },
        ...
        public static List<ListItem> FormType
        {
            get
            {
                List<ListItem> items = new List<ListItem>
                     {
                             new ListItem{ Text="Mutawalli", Value = "Mutawalli" },
                             new ListItem{ Text="Management Committee", Value = "Management Committee" },
        ...
        public static List<ListItem> PropFallsUnder
        {
            get
            {
                List<ListItem> items = new List<ListItem>
                     {
                             new ListItem{ Text="Rural Area", Value = "Rural Area" },
                             new ListItem{ Text="Urban Area", Value = "Urban Area" },

                     };
                return items;
            }
        }
        public static List<ListItem> AnnualReturn
        {
            get
            {
                List<ListItem> items = new List<ListItem>
                     {
                             new ListItem{ Text="Yes", Value = "Yes" },
        ...
        public static List<ListItem> Hospital_ServiceType
        {
            get
            {
                List<ListItem> items = new List<ListItem>
                     {
                             ...
                             new ListItem{ Text="Pathology", Value = "Pathology" },
                               new ListItem{ Text="Radiology", Value = "Radiology" },
                                 new ListItem{ Text="Miscellaneous", Value = "Miscellaneous" },
                     };
                return items;
            }
        }

        public static List<ListItem> paymentmodehospital
        {
            get
            {
                List<ListItem> items = new List<ListItem>
                     {
                             new ListItem{ Text="Cash", Value = "Cash" },
                             new ListItem{ Text="Debit Card", Value = "Debit Card" },
                     };
                return items;
            }
        }
        public static List<ListItem> paymentstatus
        {
            get
            {
                List<ListItem> items = new List<ListItem>
                     {
                             new ListItem{ Text="Pending", Value = "Pending" },
                             new ListItem{ Text="Complete", Value = "Complete" },
                     };
                return items;
            }
        }
